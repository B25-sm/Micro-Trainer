    ...
    <>
      ...
      >
        <div className="relative h-full">
          <div
            className="relative flex h-full flex-col overflow-hidden border-r border-black/[0.055] dark:border-white/[0.055] bg-[#fcfcfc] dark:bg-[#100c17] read-mode:bg-[var(--read-surface-elevated)] read-mode:border-[var(--read-border)]"
          >
            <button
              type="button"
              onClick={closeMobile}
